...
export default async function decorate(block) {
  ...
  const url = `https://publish-p142460-e1463132.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
