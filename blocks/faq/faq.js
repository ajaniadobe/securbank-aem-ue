...
export default async function decorate(block) {
  ...
  const url = `https://publish-p142404-e1461341.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
